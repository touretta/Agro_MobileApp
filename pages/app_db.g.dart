  ...
  BunkerData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return BunkerData(
      ...
      ostatokNachaloName: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}ostatokNachalo_name'])!,
      prixodName: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}prixod_name'])!,
      rasxodName: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}rasxod_name'])!,
      ostatokKonecName: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}ostatokKonec_name'])!,
    );
  }
...
class BunkerData extends DataClass implements Insertable<BunkerData> {
  ...
  final int ostatokNachaloName;
  final int prixodName;
  final int rasxodName;
  final int ostatokKonecName;
  const BunkerData(
      {required this.id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['ostatokNachalo_name'] = Variable<int>(ostatokNachaloName);
    map['prixod_name'] = Variable<int>(prixodName);
    map['rasxod_name'] = Variable<int>(rasxodName);
    map['ostatokKonec_name'] = Variable<int>(ostatokKonecName);
    return map;
  }
  ...
  factory BunkerData.fromJson(Map<String, dynamic> json,
    ...
    return BunkerData(
      ...
      ostatokNachaloName: serializer.fromJson<int>(json['ostatokNachaloName']),
      prixodName: serializer.fromJson<int>(json['prixodName']),
      rasxodName: serializer.fromJson<int>(json['rasxodName']),
      ostatokKonecName: serializer.fromJson<int>(json['ostatokKonecName']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'ostatokNachaloName': serializer.toJson<int>(ostatokNachaloName),
      'prixodName': serializer.toJson<int>(prixodName),
      'rasxodName': serializer.toJson<int>(rasxodName),
      'ostatokKonecName': serializer.toJson<int>(ostatokKonecName),
    };
  }
  ...
  BunkerData copyWith(
          ...
          String? uchastokName,
          int? ostatokNachaloName,
          int? prixodName,
          int? rasxodName,
          int? ostatokKonecName}) =>
      BunkerData(
        id: id ?? this.id,
...
class BunkerCompanion extends UpdateCompanion<BunkerData> {
  ...
  final Value<int> ostatokNachaloName;
  final Value<int> prixodName;
  final Value<int> rasxodName;
  final Value<int> ostatokKonecName;
  ...
  BunkerCompanion.insert({
    ...
    required int ostatokNachaloName,
    required int prixodName,
    required int rasxodName,
    required int ostatokKonecName,
  })  : ploshadkaName = Value(ploshadkaName),
        uchastokName = Value(uchastokName),
        ostatokNachaloName = Value(ostatokNachaloName),
        prixodName = Value(prixodName),
  ...
  static Insertable<BunkerData> custom({
    ...
    Expression<int>? ostatokNachaloName,
    Expression<int>? prixodName,
    Expression<int>? rasxodName,
    Expression<int>? ostatokKonecName,
  }) {
  ...
  BunkerCompanion copyWith(
      ...
      Value<int>? ostatokNachaloName,
      Value<int>? prixodName,
      Value<int>? rasxodName,
      Value<int>? ostatokKonecName}) {
    return BunkerCompanion(
      id: id ?? this.id,
      ploshadkaName: ploshadkaName ?? this.ploshadkaName,
      uchastokName: uchastokName ?? this.uchastokName,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (ostatokNachaloName.present) {
      map['ostatokNachalo_name'] = Variable<int>(ostatokNachaloName.value);
    }
    if (prixodName.present) {
      map['prixod_name'] = Variable<int>(prixodName.value);
    }
    if (rasxodName.present) {
      map['rasxod_name'] = Variable<int>(rasxodName.value);
    }
    if (ostatokKonecName.present) {
      map['ostatokKonec_name'] = Variable<int>(ostatokKonecName.value);
    }
    return map;
  }
...
class $$BunkerTableFilterComposer extends Composer<_$AppDb, $BunkerTable> {
  ...
  ColumnFilters<int> get ostatokNachaloName => $composableBuilder(
      column: $table.ostatokNachaloName,
      builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get prixodName => $composableBuilder(
      column: $table.prixodName, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get rasxodName => $composableBuilder(
      column: $table.rasxodName, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get ostatokKonecName => $composableBuilder(
...
class $$BunkerTableOrderingComposer extends Composer<_$AppDb, $BunkerTable> {
  ...
  ColumnOrderings<int> get ostatokNachaloName => $composableBuilder(
      column: $table.ostatokNachaloName,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get prixodName => $composableBuilder(
      column: $table.prixodName, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get rasxodName => $composableBuilder(
      column: $table.rasxodName, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get ostatokKonecName => $composableBuilder(
      column: $table.ostatokKonecName,
      builder: (column) => ColumnOrderings(column));
}
...
class $$BunkerTableAnnotationComposer extends Composer<_$AppDb, $BunkerTable> {
  ...
  GeneratedColumn<int> get ostatokNachaloName => $composableBuilder(
      column: $table.ostatokNachaloName, builder: (column) => column);

  GeneratedColumn<int> get prixodName => $composableBuilder(
      column: $table.prixodName, builder: (column) => column);

  GeneratedColumn<int> get rasxodName => $composableBuilder(
      column: $table.rasxodName, builder: (column) => column);

  GeneratedColumn<int> get ostatokKonecName => $composableBuilder(
  ...
  $$BunkerTableTableManager(_$AppDb db, $BunkerTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<int> ostatokNachaloName = const Value.absent(),
            Value<int> prixodName = const Value.absent(),
            Value<int> rasxodName = const Value.absent(),
            Value<int> ostatokKonecName = const Value.absent(),
          }) =>
              BunkerCompanion(
            id: id,
